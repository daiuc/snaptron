...
- Specifically, an outlier intron is qualified only if the median excision ratio of samples in the (95, 100] percentile is more than 2x sd away from the median excision ratio of samples in the (0, 95] percentiles, where `sd` is estimated by (0,95] percentiles. 
