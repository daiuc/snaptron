...
quantilePass = function(v, quantile.threshold = .95, sd.multiplier = 1){
...
- Specifically, an outlier intron is qualified only if the mean excision ratio of samples in the (95, 100] percentile is more than 2x sd away from the 95th percentile, where `sd` is estimated by (0,95] percentiles. 
...
In summary, the two box plots below plotted some of the outlier introns that satisfy these criteria: 
  ...
  5. **AND** exclude outliers from extreme samples
