...
GTEx[rail_id %in% samples_set1][
  , .(rail_id, Sex, AGE, Histological_Type, Analyte_Type, spots, SMPTHNTS, SMSMPSTE, SMSTYP, SMNABTCHT, TRTPTREF, DTHFUCOD, DTHMNNR)
...
GTEx[rail_id %in% samples_set2][
  , .(rail_id, Sex, AGE, Histological_Type, Analyte_Type, spots, SMPTHNTS, SMSMPSTE, SMSTYP, SMNABTCHT, TRTPTREF, DTHFUCOD, DTHMNNR)
] %>% head(5) %>% DT::datatable(., options = list(scrollX = T)) 
```
